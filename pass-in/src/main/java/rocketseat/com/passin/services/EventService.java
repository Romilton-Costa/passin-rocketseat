...
public class EventService {
    ...
    public AttendeeIdDTO registerAttendeeOnEvent(String eventId, EventRequestDTO attendeeRequestDTO){
    ...
    private String createSlug(String text){
        ...
        return normalized.replaceAll("[\\p{InCOMINING_DIACRITICAL_MARKS}]","")
                .replaceAll("[^\\w\\s]","")
                .replaceAll("\\s+","-")
                .toLowerCase();
    }
